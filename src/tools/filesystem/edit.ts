...
export const definition: ToolDefinition = {
  ...
  handler: async (params, context): Promise<ToolResult> => {
    ...
    const insertAt = params.insertAt as number | undefined;
    const deleteLines = params.deleteLines as string | undefined;
    ...
    try {
      ...
      return { success: false, output: '', error: `Edit error: ${(error as Error).message}` };
    }
  },
};
