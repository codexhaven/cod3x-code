...
export type ToolCategory = 'filesystem' | 'execution' | 'search' | 'git' | 'code' | 'analysis' | 'network' | 'database' | 'documentation' | 'testing' | 'utility' | 'browser' | 'debug' | 'ai' | 'project';
...
export type AgentRole = 'code-generator' | 'code-reviewer' | 'debugger' | 'architect' | 'tester' | 'documenter' | 'git-manager' | 'security-auditor' | 'optimizer' | 'browser' | 'swarm-leader' | 'task-decomposer' | 'error-analyst' | 'trail-runner';
