...
export class ToolRegistry {
    ...
    constructor() {
        ...
        this.context = {
            ...
            permissions: {
                ask: async (request) => {
                    const toolName = request.details?.tool || '';
                ...
                check: async (action, details) => {
                    const toolName = details?.tool || action;
     ...
     */
    async logPermission(tool, granted, reason) {
        try {
